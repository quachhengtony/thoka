...
//                   <h3 className="mb-3">Team workspaces</h3>
                          ...
                          <div className="row g-2 align-items-center">
                            ...
                            <div className="col-auto lh-1">
                              <div className="dropdown">
                                ...
                                <div className="dropdown-menu dropdown-menu-end">
                                  <a className="dropdown-item" href="javascript:void(0)" onClick={() => handleRemoveWorkspaceFromUser(linkWorkspace.workspaceId)}>
                                    Remove
                                  </a>
                                </div>
                              </div>
